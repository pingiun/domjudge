 ...
 */
final class Version20201103150505 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Add new JudgeTask entity for the new judgehost API.';
    }
